...
const FollowButton = ({ userId, onFollowChange }) => {
  ...
  const checkConnectionStatus = async () => {
    try {
      const response = await axios.get(`https://collegeconnectwebsite-1.onrender.com/api/users/connections/${userId}`, config)
  ...
  const handleUnfollow = async () => {
    try {
      setLoading(true)
      await axios.delete(`https://collegeconnectwebsite-1.onrender.com/api/users/unfollow/${userId}`, config)
      setConnectionStatus("none")
