...
const EventsPage = () => {
  ...
  const fetchEvents = async () => {
    try {
      const response = await axios.get("https://collegeconnectwebsite-1.onrender.com/api/events");
  ...
  const deleteExpiredEvents = async () => {
    ...
    if (validEvents.length !== events.length) {
      try {
        await axios.post("https://collegeconnectwebsite-1.onrender.com/api/events/deleteExpired", {
  ...
  const addEvent = async () => {
    ...
    try {
      await axios.post("https://collegeconnectwebsite-1.onrender.com/api/events", formData, {
