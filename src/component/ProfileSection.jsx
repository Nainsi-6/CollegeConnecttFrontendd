...
//               ? `https://collegeconnectwebsite-1.onrender.com${displayData.profilePhotoUrl}`
...
const ProfileSection = ({ className = "" }) => {
  ...
  const fetchUserProfile = async () => {
    ...
    try {
      const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/profiles/${user._id}`, {
        headers: {
