...
//         // Fetch profile
//         const profileResponse = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/profiles/${userId}`, {
//           headers: {
...
//           const connectionsResponse = await fetch("https://collegeconnectwebsite-1.onrender.com/api/users/connections", {
//             headers: {
//               Authorization: `Bearer ${localStorage.getItem("token")}`,
//             },
//           })
...
//     try {
//       const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/users/connect/${userId}`, {
//         method: "POST",
//         headers: {
//           Authorization: `Bearer ${localStorage.getItem("token")}`,
...
//     try {
//       const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/users/connections/${connectionId}`, {
//         method: "DELETE",
//         headers: {
//           Authorization: `Bearer ${localStorage.getItem("token")}`,
//         },
...
//     try {
//       const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/users/connections/${connectionId}/accept`, {
//         method: "PUT",
//         headers: {
//           Authorization: `Bearer ${localStorage.getItem("token")}`,
//         },
...
//             <img
//               src={`https://collegeconnectwebsite-1.onrender.com${profile.coverPhotoUrl}`}
//               alt="Cover"
...
//                 <img
//                   src={`https://collegeconnectwebsite-1.onrender.com${profile.profilePhotoUrl}`}
//                   alt={profile.name}
