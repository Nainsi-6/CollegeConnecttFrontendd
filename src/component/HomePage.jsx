...
//     try {
//       const response = await fetch("https://collegeconnectwebsite-1.onrender.com/api/announcements");
//       if (!response.ok) {
...
//     try {
//       const response = await fetch("https://collegeconnectwebsite-1.onrender.com/api/achievements");
//       if (!response.ok) {
...
//   //   try {
//   //     const res = await fetch("https://collegeconnectwebsite-1.onrender.com/api/posts");
...
//     try {
//       const response = await fetch("https://collegeconnectwebsite-1.onrender.com/api/posts", {
//         method: "POST",
//         body: formData,
//       });
...
//     try {
//       const res = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/posts/${postId}/like`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
...
//     try {
//       const res = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/posts/${postId}/dislike`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ userId: user._id }),
//       })
...
//     try {
//       const res = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/posts/${postId}/comment`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({
//           text,
...
//     try {
//       const res = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/posts/${postId}`, {
//         method: "DELETE",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ userId: user._id }),
//       })
...
//     try {
//       const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/posts/${postId}/report`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
...
//     try {
//       const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/posts/${postId}/save`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ userId: user._id }),
//       })
