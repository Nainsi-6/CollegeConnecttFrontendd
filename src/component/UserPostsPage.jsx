...
const UserPostsPage = () => {
  ...
  const fetchUserPosts = async () => {
    try {
      ...
      const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/posts/user/${targetUserId}`)
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      const response = await fetch(`https://collegeconnectwebsite-1.onrender.com/api/users/${targetUserId}`)
