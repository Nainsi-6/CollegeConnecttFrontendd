...
//       const response = await axios.get("https://collegeconnectwebsite-1.onrender.com/api/users/requests", config)
...
//       const response = await axios.get("https://collegeconnectwebsite-1.onrender.com/api/users/suggested", config)
...
//       const response = await axios.get(`https://collegeconnectwebsite-1.onrender.com/api/users/search?query=${searchQuery}`, config)
...
//     try {
//       await axios.post(`https://collegeconnectwebsite-1.onrender.com/api/users/follow/${userId}`, {}, config)
...
//     try {
//       await axios.put(`https://collegeconnectwebsite-1.onrender.com/api/users/request/${requestId}`, { action }, config)
...
//   const handleRequestResponse = async (requestId, action) => {
//     try {
//       const response = await axios.put(`https://collegeconnectwebsite-1.onrender.com/api/users/request/${requestId}`, { action }, config)
...
//       const response = await axios.post(`https://collegeconnectwebsite-1.onrender.com/api/users/respond/${requestId}`, { action }, config)
...
const ConnectPeople = () => {
  ...
  const handleFollow = async (userId) => {
    try {
      const response = await axios.post(`https://collegeconnectwebsite-1.onrender.com/api/users/follow/${userId}`, {}, config)
